...
全站文案采用“清楚为正文，诗意作题眼”的克制层级，不把每个标签、状态和说明都写成连续歌词：

- Hero 之外，每个页面最多保留一处高记忆度意象。Plog、Links、Guestbook 与 404 可在页首使用原创的地理蒙太奇、光线、旅途或书页意象，但同一段不连续堆叠地名和比喻。
- 页面标题必须直接说明领域；页面说明先交代内容或功能，再用一句自然意象收尾。About 的完整叙事可更抒情，但不得虚构地点、经历、旅行或个人事实。
